...
int main(int argn, char* args[])
{
    ...
    fullString = "a";
    fullString.pop_back();
    FILE *abdu = fopen("abdu.typo","r+a");
    while(fgets(fullFile, sizeof(fullFile), abdu)!=NULL){
      fullString+= fullFile;
    }
//  fgets(fullfile, 100000, abdu);
    printf("%d\n",strlen(fullString.c_str()) );
    ...
    SDL_Rect  timeViewRect = {SCREEN_WIDTH - 500, 33, 400, 28};
                ...
                while(SDL_PollEvent(&e)!=0)
                {
                    ...
                    if(e.type == SDL_MOUSEBUTTONDOWN)
                    {
                        ...
                        else if(newMenuBool==true && (e.button.x > (10*SCREEN_WIDTH)/2000 && e.button.x < (193*SCREEN_WIDTH)/2000 && e.button.y > (265*SCREEN_HEIGHT)/1000 && e.button.y < (316*SCREEN_HEIGHT)/1000))
                        {
                          ...
                          FILE *resumeFile = fopen(date.c_str(),"a");
                        ...
                        else if( !(newMenuBool || preferenceMenuBool || viewMenuBool) && e.button.x<SCREEN_WIDTH-100 && e.button.y >80&&e.button.y<total_line*50+130 )
                        {
...
//  menu show
                ...
                sprintf(show_time, "%2d-%2d-%2d %2d:%2d:%2d", tm.tm_year + 1900, tm.tm_mon + 1,tm.tm_mday, tm.tm_hour%12, tm.tm_min, tm.tm_sec);
